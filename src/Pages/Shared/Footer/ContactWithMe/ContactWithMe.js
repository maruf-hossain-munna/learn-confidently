...
const ContactWithMe = () => {
    return (
        <div className='container mx-auto my-12 lg:px-0 px-4'>
            <div className='lg:flex'>
                <div className='lg:w-2/3 lg:mr-12'>
                    <h2 className='lg:text-5xl text-3xl font-bold my-4'>Send A Message</h2>
                ...
                <div className='px-6 py-8 bg-slate-100 rounded-xl lg:mt-0 mt-10'>
                    ...
                    <div className='flex items-center my-6'>
                        ...
                        <div>
                            ...
                            <p className='lg:text-xl text-sm font-semibold'> marufhossainmunna21@gmail.com </p>
                        </div>
                    </div>
